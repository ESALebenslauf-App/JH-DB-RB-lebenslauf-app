...
public interface LebenslaufDB {
	...
	String[] PROJECTION_BILDUNG = new String[] { BILDUNG_BILDUNGSART, BILDUNG_SCHULNAME, BILDUNG_PLZ, BILDUNG_ORT, BILDUNG_VON, BILDUNG_BIS};
	...
	static String SQL_CREATE_TABLE_BERUF = "CREATE TABLE BERUFSERFAHRUNG("
			+ "BERUFSID INTEGER PRIMARY KEY AUTO_INCREMENT,"
			+ "FIRMA TEXT NOT NULL,"
	...
	static String SQL_CREATE_TABLE_BILDUNG = "CREATE TABLE BILDUNG("
			+ "BILDUNGSID INTEGER PRIMARY KEY AUTO_INCREMENT,"
	...
	static String SQL_CREATE_TABLE_SKILLS = "CREATE TABLE SKILLS("
			+ "SKILLSID INTEGER PRIMARY KEY AUTO_INCREMENT,"
			+ "WAS TEXT NOT NULL,"
